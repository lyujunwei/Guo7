...
- (id)initWithFrame:(CGRect)frame {
  ...
  if (self) {
    ...
    [_oneStarButton setImage:[UIImage imageNamed:@"noselectStar"] forState:UIControlStateNormal];
    [_oneStarButton setImage:[UIImage imageNamed:@"selectStar"] forState:UIControlStateSelected];
    ...
    [_twoStarButton setImage:[UIImage imageNamed:@"noselectStar"] forState:UIControlStateNormal];
    [_twoStarButton setImage:[UIImage imageNamed:@"selectStar"] forState:UIControlStateSelected];
    ...
    [_threeStarButton setImage:[UIImage imageNamed:@"noselectStar"] forState:UIControlStateNormal];
    [_threeStarButton setImage:[UIImage imageNamed:@"selectStar"] forState:UIControlStateSelected];
    ...
    [_fourStarButton setImage:[UIImage imageNamed:@"noselectStar"] forState:UIControlStateNormal];
    [_fourStarButton setImage:[UIImage imageNamed:@"selectStar"] forState:UIControlStateSelected];
    ...
    [_fiveStarButton setImage:[UIImage imageNamed:@"noselectStar"] forState:UIControlStateNormal];
    [_fiveStarButton setImage:[UIImage imageNamed:@"selectStar"] forState:UIControlStateSelected];
